...
<!--&lt;!&ndash;          v-hasPermi="['teaching:teaching:add']"&ndash;&gt;-->
...
<!--&lt;!&ndash;          v-hasPermi="['teaching:teaching:edit']"&ndash;&gt;-->
...
<!--&lt;!&ndash;          v-hasPermi="['teaching:teaching:remove']"&ndash;&gt;-->
...
<!--&lt;!&ndash;          v-hasPermi="['teaching:teaching:export']"&ndash;&gt;-->
...
<!--          </el-select>-->
<!--        </el-form-item>-->
<!--&lt;!&ndash;        <el-form-item label="图JSON结构数据" prop="graphData">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-input v-model="form.graphData" type="textarea" placeholder="请输入内容" />&ndash;&gt;-->
<!--&lt;!&ndash;        </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;        <el-form-item label="节点数量" prop="nodeCount">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-input v-model="form.nodeCount" placeholder="请输入节点数量" />&ndash;&gt;-->
<!--&lt;!&ndash;        </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;        <el-form-item label="边数量" prop="edgeCount">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-input v-model="form.edgeCount" placeholder="请输入边数量" />&ndash;&gt;-->
<!--&lt;!&ndash;        </el-form-item>&ndash;&gt;-->
