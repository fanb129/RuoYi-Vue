...
<script>
import {listOrder, getOrder, delOrder, addOrder, updateOrder, confirmReceive, listOrderBuyer} from "@/api/order/order"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listOrderBuyer(this.queryParams).then(response => {
