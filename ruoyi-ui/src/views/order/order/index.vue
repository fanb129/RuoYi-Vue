<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="对方昵称" align="center">
        <template slot-scope="scope">
          <span v-if="isBuyer(scope.row)">{{ scope.row.sellerNickName || '-' }}</span>
          <span v-else-if="isSeller(scope.row)">{{ scope.row.buyerNickName || '-' }}</span>
          <span v-else>-</span>
        </template>
      </el-table-column>
